...
void datahandler_forceSingleCoil(ModbusSlave *slave){
	...
	// Reference to MODBUS Data Map
	Uint16 * registersPtr;
	registersPtr = (Uint16 *)&(slave->coils);
